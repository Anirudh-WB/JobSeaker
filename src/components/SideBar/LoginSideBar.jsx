...
function LoginSidebar({ isOpen, toggleSidebar }) {
  return (
    <div
      className={`fixed top-0 right-0 w-1/3 h-full rounded-tl-3xl rounded-bl-3xl shadow-gray-600 bg-slate-200 text-white transition-transform z-50 ${
    ...
    >
      ...
      <form className="flex flex-col gap-4 p-8">
        <label className="font-semibold text-black">Email ID / Username</label>
        <input
          type="text"
          placeholder="Email or Username"
          className="p-3 w-full rounded-xl text-black placeholder-gray-500"
        />
