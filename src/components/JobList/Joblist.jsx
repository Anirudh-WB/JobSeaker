  ...
  return (
    <div className="flex gap-2 px-32">
      ...
      <div className="mt-5 flex-1 flex flex-col gap-5 rounded h-fit">
        {jobs.map((job, index) => (
          <div key={index} className="bg-white border rounded border-gray-200 shadow h-fit p-5">
            <div>
            ...
            <div className="flex items-center gap-1 flex-wrap text-sm p-2 text-gray-700">
              {job.skills.map((skill, skillIndex) => (
                <span key={skillIndex} className="border rounded-full px-3 py-1">
                  {skill}
                </span>
              ))}
            </div>
