...
function Resume() {
  return (
    <div className="p-5 bg-white rounded-xl shadow-md h-fit flex-1 flex flex-col gap-5">
      ...
      <div className="border rounded-lg border-dashed border-gray-400 flex flex-col items-center justify-center gap-1 p-7 text-sm">
        ...
        <p className="text-gray-600">Supported Formats: doc, docx, rtf, pdf, upto 2 MB</p>
      </div>
    </div>
  );
}
